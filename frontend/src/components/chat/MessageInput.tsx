        ...
        <div className="flex-1 relative">
          <textarea
            ...
            placeholder={
              ...
              disabled={loading}
              className="w-full resize-none overflow-hidden py-3 px-4 rounded-lg border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white"
            />
          ...
          <button
            ...
            className="flex-shrink-0 p-3 rounded-lg bg-primary-500 text-white disabled:opacity-50 disabled:cursor-not-allowed hover:bg-primary-600 transition-colors"
          >
            {loading ? (
