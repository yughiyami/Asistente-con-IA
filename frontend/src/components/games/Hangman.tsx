      ...
      {!completed && (
        <div className="mt-4 flex w-full max-w-xs">
          <input
            ...
            className="flex-1 p-2 border border-gray-300 dark:border-gray-700 rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-white"
          />
          <button
